# sklearn_tda: A scikit-learn compatible library for Machine Learning and TDA
...
**sklearn_tda** is a library compatible with the project of [scikit-learn](http://scikit-learn.org/)
...
Usage
=====
To learn how to use the sklearn_tda api **as a user**, please read the [documentation][doc].
...
<!--- Citation
========
If you use sklearn_tda in a scientific publication, please cite our paper:
```
@article{,
  title={},
  author={},
